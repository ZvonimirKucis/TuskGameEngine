...
namespace Tusk {
	...
	VulkanTexture::VulkanTexture(const std::string& textureFile) {
        _textureFile = textureFile;
	}

    void VulkanTexture::bind(VulkanDevice* device, VulkanCommand* command) {
	...
	void VulkanTexture::createTextureImage() {
        ...
        stbi_uc* pixels = stbi_load(_textureFile.c_str(), &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        ...
        VulkanBufferHelper::createBuffer(_device, imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, stagingBuffer, stagingBufferMemory);
    ...
    void VulkanTexture::createTextureImageView() {
        ...
        VK_CHECK(vkCreateImageView(_device->getDevice(), &viewInfo, nullptr, &_textureImageView))
    }
